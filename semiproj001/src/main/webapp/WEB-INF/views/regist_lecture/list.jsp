...
<input class="form-control-plaintext" type="text" value="강의 목록" style="padding: 13px 0px;padding-left: 21px;font-size: 21px;font-family: 'Source Sans Pro', sans-serif;font-weight: 500;font-style: normal;">
    <div class="list-group">  
		...
		<div class="list-group-item list-group-item-action flex-column align-items-start" >
            ...
            <p class="mb-1" style="font-size: 15px;"></p><small class="text-muted">${dto.lecture_subname}</small>
        </div>
       </c:forEach>
      </div><button class="btn btn-primary float-right" type="button" style="margin-right: 23px;margin-top: 17px;margin-bottom: 0px;background: #07689f;">수강취소</button>    
