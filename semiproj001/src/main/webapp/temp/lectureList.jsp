	...
	<div class="list-group">
		<a
			...
			href="#"> <c:forEach var="dto" items="${list}">
				...
				<button class="btn btn-primary float-right" type="button" style="background: #1F90A3; border-color: #1F90A3" onclick="javascript:location.href='${articleUrl}&num=${dto.opened_code}'">자세히</button> 
				<hr>
			</c:forEach>
